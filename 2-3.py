...
if driving_mode == 'A':
    ...
    fuel_consumption = 9
else: # no reason to use elif here, we can just make it a fallback value for everything else
    fuel_consumption = 6

total_consumption = distance * (fuel_consumption / 100)
print(f'Total fuel consumption over a distance of {distance} km in driving mode {driving_mode} is {total_consumption:.0f} liters')